...
3. **Confirm the balance** in both the Console and on the [Arc block explorer](https://explorer.arc.network)
...
A Circle Programmable Wallet with a USDC balance, visible in both the Console and the explorer.
